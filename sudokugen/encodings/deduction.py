...
#         use_technique(Mode,x_chain_proper_chained), deduction_mode(Mode),
#         cell(C), cell(C1), cell(C2), cell(C3), cell(C4),
#         not certainly_not_erased(C),
#         not certainly_not_erased(C1),
#         not certainly_not_erased(C2),
#         not certainly_not_erased(C3),
...
#         value(V),
#         derivable(Mode,x_chain_or(C1,yes(V),C2,yes(V))),
#         derivable(Mode,x_chain_or(C2,no(V),C3,no(V))),
#         not derivable(Mode,x_chain_or(C2,yes(V),C3,yes(V))),
#         share_group(C2,C3),
#         derivable(Mode,x_chain_or(C3,yes(V),C4,yes(V))),
#         share_group(C,C1), share_group(C,C4),
#         different_cells(C1,C2), different_cells(C1,C3), different_cells(C1,C4),
#         different_cells(C2,C3), different_cells(C2,C4),
...
#         not certainly_not_erased(C2),
#         share_group(C1,C2).
#     derivable(Mode,x_chain_or_proper(C1,no(V),C2,no(V))) :-
#         use_technique(Mode,x_chain_proper_chained), deduction_mode(Mode),
...
#     derivable(Mode,x_chain_or(C1,S1,C2,S2)) :-
#         derivable(Mode,x_chain_or(C2,S2,C1,S1)).
#     derivable(Mode,x_chain_or_proper(C1,S1,C2,S2)) :-
#         derivable(Mode,x_chain_or_proper(C2,S2,C1,S1)).
#     derivable(Mode,x_chain_or_proper(C1,S1,C3,S3)) :-
#         use_technique(Mode,x_chain_proper_chained), deduction_mode(Mode),
#         derivable(Mode,x_chain_or(C1,S1,C2,yes(V))),
#         derivable(Mode,x_chain_or_proper(C2,no(V),C3,S3)),
#         different_cells(C1,C2), different_cells(C2,C3),
#         different_cells(C1,C3),
#         not certainly_not_erased(C1),
#         not certainly_not_erased(C2),
...
#     derivable(Mode,x_chain_or_proper(C1,S1,C3,S3)) :-
#         use_technique(Mode,x_chain_proper_chained), deduction_mode(Mode),
#         derivable(Mode,x_chain_or_proper(C1,S1,C2,yes(V))),
#         derivable(Mode,x_chain_or(C2,no(V),C3,S3)),
#         different_cells(C1,C2), different_cells(C2,C3),
#         different_cells(C1,C3),
#         not certainly_not_erased(C1),
...
#     derivable(Mode,x_chain_or_proper(C1,S1,C3,S3)) :-
#         use_technique(Mode,x_chain_proper_chained), deduction_mode(Mode),
#         derivable(Mode,x_chain_or(C1,S1,C2,no(V))),
#         derivable(Mode,x_chain_or_proper(C2,yes(V),C3,S3)),
#         different_cells(C1,C2), different_cells(C2,C3),
#         different_cells(C1,C3),
#         not certainly_not_erased(C1),
#         not certainly_not_erased(C2),
...
#     derivable(Mode,x_chain_or_proper(C1,S1,C3,S3)) :-
#         use_technique(Mode,x_chain_proper_chained), deduction_mode(Mode),
#         derivable(Mode,x_chain_or_proper(C1,S1,C2,no(V))),
#         derivable(Mode,x_chain_or(C2,yes(V),C3,S3)),
#         different_cells(C1,C2), different_cells(C2,C3),
#         different_cells(C1,C3),
#         not certainly_not_erased(C1),
#         not certainly_not_erased(C2),
...
#         cell(C), not certainly_not_erased(C),
#         value(V),
#         derivable(Mode,x_chain_or_proper(C1,yes(V),C2,yes(V))),
#         share_group(C,C1), share_group(C,C2),
#         different_cells(C,C1),
#         different_cells(C,C2),
#         different_cells(C1,C2).
