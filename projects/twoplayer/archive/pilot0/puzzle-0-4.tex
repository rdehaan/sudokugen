...
\node[anchor=center] at (2.5,2.5) {\Large 8};
\node[anchor=center] at (2.5,1.5) {};
\node[anchor=center] at (2.5,0.5) {\Large 4};
...
\node[anchor=center] at (4.5,5.5) {\Large 1};
...
\node[anchor=center] at (8.5,3.5) {\Large 5};
...
\node[anchor=center, minimum width=17pt, minimum height=17pt, pattern={Lines[distance=1.5pt,yshift=0.85pt]}, pattern color=NavyBlue!60] at (8.5,0.5) {};
        ...
        % short form: 300000000002905003051000000000010049000700200400000005908200000000000860074000010
    %
  };
  % PLAYER A, NUMBER 2
...
\node[anchor=center] at (0.5,6.5) {};
\node[anchor=center] at (0.5,5.5) {};
\node[anchor=center] at (0.5,4.5) {\Large 2};
...
\node[anchor=center] at (8.5,0.5) {};
        ...
        % short form: 900000700400010000070200800060903050200500000000040670000006140010890000050070380
    %
  };
  % PLAYER A, NUMBER 3
...
\node[anchor=center] at (1.5,5.5) {};
\node[anchor=center] at (1.5,4.5) {\Large 9};
\node[anchor=center] at (1.5,3.5) {};
\node[anchor=center] at (1.5,2.5) {};
\node[anchor=center] at (1.5,1.5) {};
...
\node[anchor=center] at (6.5,7.5) {};
\node[anchor=center] at (6.5,6.5) {};
\node[anchor=center] at (6.5,5.5) {\Large 9};
\node[anchor=center] at (6.5,4.5) {};
\node[anchor=center] at (6.5,3.5) {};
\node[anchor=center] at (6.5,2.5) {};
\node[anchor=center] at (6.5,1.5) {};
...
\node[anchor=center] at (7.5,6.5) {};
\node[anchor=center, minimum width=17pt, minimum height=17pt, pattern={Lines[distance=1.5pt,yshift=0.85pt]}, pattern color=NavyBlue!60] at (7.5,5.5) {};
...
\node[anchor=center] at (8.5,0.5) {\Large 5};
        ...
        % short form: 540000200600004010083020000100000900090000086000067000000040000008000002030800795
    %
  };
  %
...
\node[anchor=center] at (6.5,7.5) {};
\node[anchor=center] at (6.5,6.5) {};
\node[anchor=center] at (6.5,5.5) {\Large 7};
\node[anchor=center] at (6.5,4.5) {\Large 6};
\node[anchor=center] at (6.5,3.5) {};
...
\node[anchor=center] at (8.5,0.5) {};
        ...
        % short form: 750200800060050090000000000000040700207003604010002000690800203001070000300004060
    %
  };
  % PLAYER B, NUMBER 2
  \node[] at (5,-10.75) {\parbox{5cm}{\sffamily \large \color{BrickRed}
...
\node[anchor=center] at (4.5,7.5) {\Large 1};
\node[anchor=center] at (4.5,6.5) {};
\node[anchor=center] at (4.5,5.5) {\Large 6};
\node[anchor=center] at (4.5,4.5) {};
...
\node[anchor=center] at (5.5,5.5) {\Large 7};
\node[anchor=center] at (5.5,4.5) {};
\node[anchor=center] at (5.5,3.5) {};
\node[anchor=center] at (5.5,2.5) {};
\node[anchor=center] at (5.5,1.5) {};
...
\node[anchor=center] at (7.5,3.5) {\Large 2};
\node[anchor=center] at (7.5,2.5) {\Large 4};
\node[anchor=center] at (7.5,1.5) {};
\node[anchor=center] at (7.5,0.5) {\Large 6};
\node[anchor=center] at (8.5,8.5) {};
...
\node[anchor=center] at (8.5,0.5) {\Large 3};
        ...
        % short form: 000000000506014030000002419005067000800000070000090120000070040002000000010040963
    %
  };
  % PLAYER B, NUMBER 3
  \node[] at (5,-18.75) %{\parbox{5cm}{\sffamily \large \color{BrickRed} }};
...
\node[anchor=center] at (0.5,6.5) {};
\node[anchor=center] at (0.5,5.5) {};
\node[anchor=center] at (0.5,4.5) {\Large 3};
\node[anchor=center] at (0.5,3.5) {\Large 5};
\node[anchor=center] at (0.5,2.5) {};
\node[anchor=center] at (0.5,1.5) {};
\node[anchor=center] at (0.5,0.5) {};
\node[anchor=center] at (1.5,8.5) {};
\node[anchor=center] at (1.5,7.5) {\Large 2};
...
\node[anchor=center] at (2.5,5.5) {};
\node[anchor=center] at (2.5,4.5) {};
\node[anchor=center] at (2.5,3.5) {\Large 1};
\node[anchor=center] at (2.5,2.5) {};
...
\node[anchor=center] at (3.5,1.5) {\Large 4};
\node[anchor=center] at (3.5,0.5) {};
\node[anchor=center] at (4.5,8.5) {};
\node[anchor=center] at (4.5,7.5) {};
\node[anchor=center] at (4.5,6.5) {};
...
\node[anchor=center] at (6.5,7.5) {\Large 7};
\node[anchor=center] at (6.5,6.5) {};
\node[anchor=center] at (6.5,5.5) {};
\node[anchor=center] at (6.5,4.5) {};
\node[anchor=center] at (6.5,3.5) {};
...
\node[anchor=center] at (8.5,0.5) {\Large 1};
        ...
        % short form: 600200380020000700005000000000030009300005000501008000000100036007490000090000001
    %
  };
  %
  \node[] at (5,-26.5) {\parbox{5cm}{\centering \sffamily Puzzle~\#%
