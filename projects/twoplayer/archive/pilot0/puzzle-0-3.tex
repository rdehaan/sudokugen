...
\node[anchor=center] at (8.5,0.5) {};
        ...
        % short form: 000005300004100090700003010070004000310700065060000000002590000800000170000000000
    %
  };
  % PLAYER A, NUMBER 2
...
\node[anchor=center] at (5.5,2.5) {};
\node[anchor=center] at (5.5,1.5) {};
\node[anchor=center, minimum width=17pt, minimum height=17pt, pattern={Lines[distance=1.5pt,yshift=0.85pt]}, pattern color=NavyBlue!60] at (5.5,0.5) {};
...
\node[anchor=center] at (8.5,0.5) {\Large 2};
        ...
        % short form: 000009008002051304000003600180004206000008003000060000476200001000000500018090002
    %
  };
  % PLAYER A, NUMBER 3
...
\node[anchor=center] at (0.5,4.5) {};
\node[anchor=center] at (0.5,3.5) {};
\node[anchor=center, minimum width=17pt, minimum height=17pt, pattern=north west lines, pattern color=BrickRed!40] at (0.5,2.5) {};
\node[anchor=center] at (0.5,1.5) {};
\node[anchor=center] at (0.5,0.5) {};
...
\node[anchor=center] at (8.5,0.5) {\Large 2};
        ...
        % short form: 060500001200007350040000008000401000008960020002000004000090187000000040000070602
    %
  };
  %
...
\node[anchor=center] at (8.5,0.5) {};
        ...
        % short form: 009000250000000000008306009260050010040009000000100064000010020900002070050040800
    %
  };
  % PLAYER B, NUMBER 2
  \node[] at (5,-10.75) {\parbox{5cm}{\sffamily \large \color{BrickRed}
...
\node[anchor=center] at (7.5,0.5) {};
\node[anchor=center] at (8.5,8.5) {\Large 4};
...
\node[anchor=center] at (8.5,0.5) {};
        ...
        % short form: 000005004002400607000910020300004092005000060084000000018000700000130080503000000
    %
  };
  % PLAYER B, NUMBER 3
  \node[] at (5,-18.75) %{\parbox{5cm}{\sffamily \large \color{BrickRed} }};
...
\node[anchor=center] at (8.5,0.5) {};
        ...
        % short form: 000000007400070200010064305180900420006048000030002580000005000340000000809000010
    %
  };
  %
  \node[] at (5,-26.5) {\parbox{5cm}{\centering \sffamily Puzzle~\#%
