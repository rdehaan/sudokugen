...
\node[anchor=center] at (8.5,0.5) {};
        ...
        % short form: 000000000608000050000230007300096204010000300000000900040020003200080010060400000
    %
  };
  % PLAYER A, NUMBER 2
...
\node[anchor=center] at (5.5,8.5) {};
\node[anchor=center] at (5.5,7.5) {};
\node[anchor=center, minimum width=17pt, minimum height=17pt, pattern=north west lines, pattern color=BrickRed!40] at (5.5,6.5) {};
...
\node[anchor=center] at (8.5,0.5) {};
        ...
        % short form: 302070000100020000907000500000000000060050409205490170000710284500000000008009600
    %
  };
  % PLAYER A, NUMBER 3
...
\node[anchor=center, minimum width=17pt, minimum height=17pt, pattern={Lines[distance=1.5pt,yshift=0.85pt]}, pattern color=NavyBlue!60] at (6.5,3.5) {};
...
\node[anchor=center] at (8.5,0.5) {\Large 1};
        ...
        % short form: 000003095000008723000000100005300640900060002100000007070089500000210000050000001
    %
  };
  %
...
\node[anchor=center] at (1.5,4.5) {};
\node[anchor=center] at (1.5,3.5) {};
\node[anchor=center, minimum width=17pt, minimum height=17pt, pattern={Lines[distance=1.5pt,yshift=0.85pt]}, pattern color=NavyBlue!60] at (1.5,2.5) {};
\node[anchor=center] at (1.5,1.5) {};
...
\node[anchor=center] at (8.5,0.5) {\Large 3};
        ...
        % short form: 059006002001800000000020109700940800000000000800000056000002005006001070080500003
    %
  };
  % PLAYER B, NUMBER 2
  \node[] at (5,-10.75) {\parbox{5cm}{\sffamily \large \color{BrickRed}
...
\node[anchor=center] at (3.5,6.5) {};
\node[anchor=center] at (3.5,5.5) {};
\node[anchor=center] at (3.5,4.5) {\Large 6};
\node[anchor=center] at (3.5,3.5) {};
\node[anchor=center] at (3.5,2.5) {};
\node[anchor=center] at (3.5,1.5) {};
\node[anchor=center] at (3.5,0.5) {};
...
\node[anchor=center] at (8.5,0.5) {};
        ...
        % short form: 009000060058100400000000017930001050010600000005028000300000072000000640007042000
    %
  };
  % PLAYER B, NUMBER 3
  \node[] at (5,-18.75) %{\parbox{5cm}{\sffamily \large \color{BrickRed} }};
...
\node[anchor=center] at (2.5,8.5) {\Large 7};
\node[anchor=center] at (2.5,7.5) {};
...
\node[anchor=center] at (8.5,0.5) {\Large 1};
        ...
        % short form: 047100002010020407008000090600010570000390010000000008000063000002000705000540601
    %
  };
  %
  \node[] at (5,-26.5) {\parbox{5cm}{\centering \sffamily Puzzle~\#%
