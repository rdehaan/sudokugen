...
\node[anchor=center] at (0.5,3.5) {\Large 5};
...
\node[anchor=center] at (6.5,2.5) {\Large 7};
\node[anchor=center] at (6.5,1.5) {\Large 4};
\node[anchor=center] at (6.5,0.5) {\Large 6};
...
\node[anchor=center] at (8.5,0.5) {\Large 8};
        ...
        % short form: 000706001052000030000000000800600007060200090500008000900000700000000400070450608
    %
  };
  % PLAYER A, NUMBER 2
...
\node[anchor=center] at (1.5,3.5) {\Large 3};
\node[anchor=center] at (1.5,2.5) {};
...
\node[anchor=center] at (2.5,2.5) {\Large 3};
...
\node[anchor=center] at (7.5,5.5) {};
\node[anchor=center] at (7.5,4.5) {\Large 4};
\node[anchor=center] at (7.5,3.5) {};
...
\node[anchor=center] at (8.5,0.5) {\Large 3};
        ...
        % short form: 040000800001000200089003650008000100000000040034160900003601020050000000006794003
    %
  };
  % PLAYER A, NUMBER 3
...
\node[anchor=center] at (1.5,8.5) {};
\node[anchor=center, minimum width=17pt, minimum height=17pt, pattern=north west lines, pattern color=BrickRed!40] at (1.5,7.5) {};
\node[anchor=center] at (1.5,6.5) {};
\node[anchor=center] at (1.5,5.5) {};
...
\node[anchor=center] at (2.5,1.5) {};
\node[anchor=center] at (2.5,0.5) {};
\node[anchor=center] at (3.5,8.5) {\Large 9};
\node[anchor=center] at (3.5,7.5) {\Large 1};
\node[anchor=center] at (3.5,6.5) {};
\node[anchor=center, minimum width=17pt, minimum height=17pt, pattern={Lines[distance=1.5pt,yshift=0.85pt]}, pattern color=NavyBlue!60] at (3.5,5.5) {};
...
\node[anchor=center] at (5.5,8.5) {};
\node[anchor=center] at (5.5,7.5) {\Large 7};
\node[anchor=center] at (5.5,6.5) {\Large 3};
...
\node[anchor=center] at (6.5,5.5) {};
\node[anchor=center] at (6.5,4.5) {};
\node[anchor=center] at (6.5,3.5) {\Large 5};
...
\node[anchor=center] at (8.5,0.5) {};
        ...
        % short form: 000900000000167020000043070009001000030580007004006500100300240000000906300009000
    %
  };
  %
  ...
  \node[] at (5,-6) {%
  \begin{tikzpicture}[scale=0.6]
\node[anchor=center, minimum width=17pt, minimum height=17pt, pattern={Lines[distance=1.5pt,yshift=0.85pt]}, pattern color=NavyBlue!60] at (0.5,8.5) {};
\node[anchor=center] at (0.5,7.5) {};
\node[anchor=center] at (0.5,6.5) {\Large 3};
\node[anchor=center] at (0.5,5.5) {};
\node[anchor=center] at (0.5,4.5) {};
\node[anchor=center] at (0.5,3.5) {\Large 2};
\node[anchor=center] at (0.5,2.5) {};
\node[anchor=center] at (0.5,1.5) {};
\node[anchor=center] at (0.5,0.5) {};
\node[anchor=center] at (1.5,8.5) {};
...
\node[anchor=center] at (2.5,0.5) {};
\node[anchor=center] at (3.5,8.5) {};
\node[anchor=center, minimum width=17pt, minimum height=17pt, pattern=north west lines, pattern color=BrickRed!40] at (3.5,7.5) {};
\node[anchor=center] at (3.5,6.5) {};
...
\node[anchor=center] at (7.5,1.5) {};
\node[anchor=center] at (7.5,0.5) {\Large 4};
...
\node[anchor=center] at (8.5,0.5) {};
        ...
        % short form: 005000009009010003306072051000200037000000000203690010070400060001000000000008040
    %
  };
  % PLAYER B, NUMBER 2
  \node[] at (5,-10.75) {\parbox{5cm}{\sffamily \large \color{BrickRed}
  ...
  \node[] at (5,-14) {%
  \begin{tikzpicture}[scale=0.6]
\node[anchor=center, minimum width=17pt, minimum height=17pt, pattern=north west lines, pattern color=BrickRed!40] at (0.5,8.5) {};
\node[anchor=center] at (0.5,7.5) {};
...
\node[anchor=center] at (4.5,0.5) {};
\node[anchor=center] at (5.5,8.5) {\Large 1};
\node[anchor=center] at (5.5,7.5) {};
\node[anchor=center] at (5.5,6.5) {};
\node[anchor=center] at (5.5,5.5) {};
\node[anchor=center] at (5.5,4.5) {};
...
\node[anchor=center, minimum width=17pt, minimum height=17pt, pattern={Lines[distance=1.5pt,yshift=0.85pt]}, pattern color=NavyBlue!60] at (7.5,8.5) {};
...
\node[anchor=center] at (8.5,0.5) {};
        ...
        % short form: 090001000000000260406090000928070004005400000000000030050038000000740050100006300
    %
  };
  % PLAYER B, NUMBER 3
  \node[] at (5,-18.75) %{\parbox{5cm}{\sffamily \large \color{BrickRed} }};
  ...
  \node[] at (5,-22) {%
  \begin{tikzpicture}[scale=0.6]
\node[anchor=center] at (0.5,8.5) {\Large 2};
\node[anchor=center] at (0.5,7.5) {};
\node[anchor=center] at (0.5,6.5) {};
\node[anchor=center] at (0.5,5.5) {};
...
\node[anchor=center] at (1.5,2.5) {};
\node[anchor=center] at (1.5,1.5) {};
\node[anchor=center] at (1.5,0.5) {\Large 1};
...
\node[anchor=center] at (4.5,6.5) {};
\node[anchor=center] at (4.5,5.5) {};
\node[anchor=center] at (4.5,4.5) {\Large 3};
...
\node[anchor=center] at (5.5,1.5) {\Large 3};
\node[anchor=center] at (5.5,0.5) {};
\node[anchor=center] at (6.5,8.5) {};
\node[anchor=center] at (6.5,7.5) {};
...
\node[anchor=center] at (8.5,0.5) {\Large 2};
        ...
        % short form: 206040039050000024000000580000405000900030008002810050000107000000093060019000002
    %
  };
  %
  \node[] at (5,-26.5) {\parbox{5cm}{\centering \sffamily Puzzle~\#%
