...
\node[anchor=center] at (0.5,6.5) {\Large 8};
...
\node[anchor=center] at (5.5,8.5) {\Large 2};
...
\node[anchor=center] at (8.5,0.5) {\Large 5};
        ...
        % short form: 000032090005000080810060003030090000007000000400085000090010200004000900000006005
    %
  };
  % PLAYER A, NUMBER 2
...
\node[anchor=center] at (1.5,1.5) {\Large 2};
\node[anchor=center] at (1.5,0.5) {};
\node[anchor=center] at (2.5,8.5) {};
...
\node[anchor=center] at (8.5,0.5) {};
        ...
        % short form: 000000000270603010400000872080000047000009050560300000050000020020070168000400000
    %
  };
  % PLAYER A, NUMBER 3
...
\node[anchor=center] at (1.5,8.5) {};
\node[anchor=center] at (1.5,7.5) {};
\node[anchor=center] at (1.5,6.5) {\Large 2};
...
\node[anchor=center] at (7.5,0.5) {};
\node[anchor=center] at (8.5,8.5) {};
\node[anchor=center, minimum width=17pt, minimum height=17pt, pattern={Lines[distance=1.5pt,yshift=0.85pt]}, pattern color=NavyBlue!60] at (8.5,7.5) {};
\node[anchor=center] at (8.5,6.5) {};
\node[anchor=center] at (8.5,5.5) {};
\node[anchor=center] at (8.5,4.5) {\Large 7};
\node[anchor=center] at (8.5,3.5) {};
\node[anchor=center] at (8.5,2.5) {};
\node[anchor=center, minimum width=17pt, minimum height=17pt, pattern=north west lines, pattern color=BrickRed!40] at (8.5,1.5) {};
\node[anchor=center] at (8.5,0.5) {\Large 8};
        ...
        % short form: 000300000001020600020000500203400080960000007004003000000901060070800030100500008
    %
  };
  %
...
\node[anchor=center] at (4.5,5.5) {};
\node[anchor=center, minimum width=17pt, minimum height=17pt, pattern={Lines[distance=1.5pt,yshift=0.85pt]}, pattern color=NavyBlue!60] at (4.5,4.5) {};
\node[anchor=center] at (4.5,3.5) {\Large 8};
\node[anchor=center] at (4.5,2.5) {\Large 1};
\node[anchor=center] at (4.5,1.5) {};
\node[anchor=center] at (4.5,0.5) {};
...
\node[anchor=center] at (6.5,7.5) {};
\node[anchor=center] at (6.5,6.5) {};
\node[anchor=center] at (6.5,5.5) {\Large 4};
\node[anchor=center] at (6.5,4.5) {};
\node[anchor=center] at (6.5,3.5) {};
...
\node[anchor=center] at (6.5,0.5) {};
\node[anchor=center] at (7.5,8.5) {};
\node[anchor=center] at (7.5,7.5) {\Large 5};
...
\node[anchor=center, minimum width=17pt, minimum height=17pt, pattern=north west lines, pattern color=BrickRed!40] at (7.5,0.5) {};
...
\node[anchor=center] at (8.5,0.5) {};
        ...
        % short form: 000008003960000050000020040075000460090706080006085002040010520100004000780602000
    %
  };
  % PLAYER B, NUMBER 2
  \node[] at (5,-10.75) {\parbox{5cm}{\sffamily \large \color{BrickRed}
...
\node[anchor=center] at (8.5,0.5) {};
        ...
        % short form: 008300000070040000200071090800000050506800209000000630004605010690000003000004700
    %
  };
  % PLAYER B, NUMBER 3
  \node[] at (5,-18.75) %{\parbox{5cm}{\sffamily \large \color{BrickRed} }};
...
\node[anchor=center] at (8.5,0.5) {};
        ...
        % short form: 000000020820000500950070030200054100006100008070009000030200047000040300600000080
    %
  };
  %
  \node[] at (5,-26.5) {\parbox{5cm}{\centering \sffamily Puzzle~\#%
