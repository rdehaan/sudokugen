...
\node[anchor=center] at (8.5,0.5) {};
        ...
        % short form: 000080601075030080000000000004000720080200000600701400200600003010008900400000100
    %
  };
  % PLAYER A, NUMBER 2
...
\node[anchor=center] at (8.5,0.5) {\Large 2};
        ...
        % short form: 080000000000300709300500201007260000000000000400080506009002040002000800003710902
    %
  };
  % PLAYER A, NUMBER 3
...
\node[anchor=center] at (8.5,0.5) {\Large 2};
        ...
        % short form: 200790400507030001000000200010900005000000600850041003900800000005000080004010002
    %
  };
  %
...
\node[anchor=center] at (4.5,5.5) {};
\node[anchor=center, minimum width=17pt, minimum height=17pt, pattern=north west lines, pattern color=BrickRed!40] at (4.5,4.5) {};
\node[anchor=center] at (4.5,3.5) {};
\node[anchor=center] at (4.5,2.5) {};
...
\node[anchor=center] at (8.5,0.5) {\Large 3};
        ...
        % short form: 500000400100002000090630000700100269000700004000000570260001000050940620800000013
    %
  };
  % PLAYER B, NUMBER 2
  \node[] at (5,-10.75) {\parbox{5cm}{\sffamily \large \color{BrickRed}
...
\node[anchor=center] at (8.5,0.5) {};
        ...
        % short form: 000820010005006000000030060008600000100000700630050002050000004000002809004900000
    %
  };
  % PLAYER B, NUMBER 3
  \node[] at (5,-18.75) %{\parbox{5cm}{\sffamily \large \color{BrickRed} }};
...
\node[anchor=center] at (8.5,0.5) {\Large 9};
        ...
        % short form: 000000004900087500000390008010500000000040200034000050000800030001020080870100609
    %
  };
  %
  \node[] at (5,-26.5) {\parbox{5cm}{\centering \sffamily Puzzle~\#%
