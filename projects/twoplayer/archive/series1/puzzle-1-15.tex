...
\node[anchor=center] at (8.5,0.5) {};
        ...
        % short form: 000010002907502008300000040039080000000000014002400000040200090700000060008037000
    %
  };
  % PLAYER A, NUMBER 2
...
\node[anchor=center] at (8.5,0.5) {};
        ...
        % short form: 000010507070803060030005000700630010000008000200100000083000002001006400000940000
    %
  };
  % PLAYER A, NUMBER 3
...
\node[anchor=center] at (5.5,4.5) {};
\node[anchor=center] at (5.5,3.5) {};
\node[anchor=center, minimum width=17pt, minimum height=17pt, pattern=north west lines, pattern color=BrickRed!40] at (5.5,2.5) {};
\node[anchor=center] at (5.5,1.5) {};
\node[anchor=center] at (5.5,0.5) {};
...
\node[anchor=center] at (8.5,0.5) {\Large 4};
        ...
        % short form: 000084300002010700000005010009000070000040000000830206003100000800000500070050064
    %
  };
  %
...
\node[anchor=center] at (8.5,0.5) {\Large 2};
        ...
        % short form: 000003020092080500000010700000050680000000000009602034603700800075000001908000302
    %
  };
  % PLAYER B, NUMBER 2
  \node[] at (5,-10.75) {\parbox{5cm}{\sffamily \large \color{BrickRed}
...
\node[anchor=center] at (8.5,0.5) {\Large 6};
        ...
        % short form: 300000094600050100002700600053010000000000900700200008007104020040300050000080006
    %
  };
  % PLAYER B, NUMBER 3
  \node[] at (5,-18.75) %{\parbox{5cm}{\sffamily \large \color{BrickRed} }};
...
\node[anchor=center] at (8.5,0.5) {};
        ...
        % short form: 380000004650700000000098000000000008071004000000027160200503000040070020000010900
    %
  };
  %
  \node[] at (5,-26.5) {\parbox{5cm}{\centering \sffamily Puzzle~\#%
