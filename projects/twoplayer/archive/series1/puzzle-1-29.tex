...
\node[anchor=center] at (8.5,0.5) {};
        ...
        % short form: 200601400450000070000090060020000900100007005000080007700004000690800000000030000
    %
  };
  % PLAYER A, NUMBER 2
...
\node[anchor=center, minimum width=17pt, minimum height=17pt, pattern=north west lines, pattern color=BrickRed!40] at (0.5,4.5) {};
\node[anchor=center] at (0.5,3.5) {};
...
\node[anchor=center] at (8.5,0.5) {};
        ...
        % short form: 370000050060002000210003000900070080000306924050000000008005047520407360000000000
    %
  };
  % PLAYER A, NUMBER 3
...
\node[anchor=center] at (8.5,0.5) {};
        ...
        % short form: 000100000009002000050706200003000406000080000160003000700200503000900020640000890
    %
  };
  %
...
\node[anchor=center] at (8.5,0.5) {\Large 5};
        ...
        % short form: 000060500000300020045100080000800170004057609000000000706002010028000003401000065
    %
  };
  % PLAYER B, NUMBER 2
  \node[] at (5,-10.75) {\parbox{5cm}{\sffamily \large \color{BrickRed}
...
\node[anchor=center] at (8.5,5.5) {};
\node[anchor=center] at (8.5,4.5) {};
\node[anchor=center, minimum width=17pt, minimum height=17pt, pattern={Lines[distance=1.5pt,yshift=0.85pt]}, pattern color=NavyBlue!60] at (8.5,3.5) {};
\node[anchor=center] at (8.5,2.5) {};
\node[anchor=center] at (8.5,1.5) {};
\node[anchor=center] at (8.5,0.5) {};
        ...
        % short form: 900050001008100090004000007000010000000794000500002000600000040130070500070200060
    %
  };
  % PLAYER B, NUMBER 3
  \node[] at (5,-18.75) %{\parbox{5cm}{\sffamily \large \color{BrickRed} }};
...
\node[anchor=center] at (8.5,0.5) {};
        ...
        % short form: 000640207000028590000003001049000020003004709507000046070000010002000008001905600
    %
  };
  %
  \node[] at (5,-26.5) {\parbox{5cm}{\centering \sffamily Puzzle~\#%
