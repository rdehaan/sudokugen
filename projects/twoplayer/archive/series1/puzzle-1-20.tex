...
\node[anchor=center] at (1.5,1.5) {\Large 9};
...
\node[anchor=center] at (3.5,2.5) {\Large 7};
...
\node[anchor=center] at (8.5,0.5) {\Large 6};
        ...
        % short form: 020600500030000200080074000000018054400090060000000001600700000090000000100050006
    %
  };
  % PLAYER A, NUMBER 2
...
\node[anchor=center] at (3.5,1.5) {};
\node[anchor=center] at (3.5,0.5) {};
\node[anchor=center, minimum width=17pt, minimum height=17pt, pattern={Lines[distance=1.5pt,yshift=0.85pt]}, pattern color=NavyBlue!60] at (4.5,8.5) {};
\node[anchor=center] at (4.5,7.5) {};
\node[anchor=center] at (4.5,6.5) {};
\node[anchor=center] at (4.5,5.5) {};
\node[anchor=center] at (4.5,4.5) {};
\node[anchor=center] at (4.5,3.5) {\Large 3};
\node[anchor=center] at (4.5,2.5) {};
\node[anchor=center] at (4.5,1.5) {};
...
\node[anchor=center] at (6.5,6.5) {\Large 9};
\node[anchor=center] at (6.5,5.5) {};
...
\node[anchor=center, minimum width=17pt, minimum height=17pt, pattern=north west lines, pattern color=BrickRed!40] at (7.5,8.5) {};
\node[anchor=center] at (7.5,7.5) {};
\node[anchor=center] at (7.5,6.5) {\Large 2};
...
\node[anchor=center] at (8.5,0.5) {};
        ...
        % short form: 000000400500803000000001925008002000120500070050130060000000190000000002693000750
    %
  };
  % PLAYER A, NUMBER 3
...
\node[anchor=center] at (2.5,1.5) {};
\node[anchor=center] at (2.5,0.5) {};
\node[anchor=center] at (3.5,8.5) {\Large 8};
\node[anchor=center] at (3.5,7.5) {};
...
\node[anchor=center] at (6.5,5.5) {};
\node[anchor=center] at (6.5,4.5) {};
\node[anchor=center] at (6.5,3.5) {\Large 4};
\node[anchor=center] at (6.5,2.5) {};
\node[anchor=center] at (6.5,1.5) {};
...
\node[anchor=center] at (8.5,8.5) {};
\node[anchor=center] at (8.5,7.5) {};
\node[anchor=center] at (8.5,6.5) {\Large 7};
...
\node[anchor=center] at (8.5,0.5) {};
        ...
        % short form: 750800090040001000060300007580060029000000070100002405090045000000600003000700900
    %
  };
  %
...
\node[anchor=center] at (1.5,4.5) {};
\node[anchor=center] at (1.5,3.5) {};
\node[anchor=center] at (1.5,2.5) {\Large 6};
\node[anchor=center] at (1.5,1.5) {};
\node[anchor=center] at (1.5,0.5) {\Large 9};
\node[anchor=center] at (2.5,8.5) {};
...
\node[anchor=center] at (2.5,0.5) {};
\node[anchor=center] at (3.5,8.5) {\Large 1};
\node[anchor=center] at (3.5,7.5) {};
\node[anchor=center] at (3.5,6.5) {};
\node[anchor=center] at (3.5,5.5) {};
...
\node[anchor=center] at (4.5,4.5) {\Large 6};
...
\node[anchor=center] at (8.5,0.5) {};
        ...
        % short form: 800100000972000004050000090000040002000760300000820510060000080007410000090350600
    %
  };
  % PLAYER B, NUMBER 2
  \node[] at (5,-10.75) {\parbox{5cm}{\sffamily \large \color{BrickRed}
...
\node[anchor=center] at (1.5,2.5) {};
\node[anchor=center] at (1.5,1.5) {};
\node[anchor=center] at (1.5,0.5) {\Large 6};
\node[anchor=center] at (2.5,8.5) {};
\node[anchor=center] at (2.5,7.5) {};
...
\node[anchor=center] at (3.5,4.5) {};
\node[anchor=center] at (3.5,3.5) {};
\node[anchor=center] at (3.5,2.5) {\Large 9};
\node[anchor=center] at (3.5,1.5) {};
\node[anchor=center] at (3.5,0.5) {};
...
\node[anchor=center] at (5.5,0.5) {};
\node[anchor=center] at (6.5,8.5) {};
\node[anchor=center] at (6.5,7.5) {\Large 8};
\node[anchor=center] at (6.5,6.5) {};
\node[anchor=center] at (6.5,5.5) {};
...
\node[anchor=center] at (8.5,0.5) {};
        ...
        % short form: 000030000050000809007000060090400000400000000100060075008900107002058300060020000
    %
  };
  % PLAYER B, NUMBER 3
  \node[] at (5,-18.75) %{\parbox{5cm}{\sffamily \large \color{BrickRed} }};
...
\node[anchor=center] at (7.5,0.5) {};
\node[anchor=center, minimum width=17pt, minimum height=17pt, pattern={Lines[distance=1.5pt,yshift=0.85pt]}, pattern color=NavyBlue!60] at (8.5,8.5) {};
\node[anchor=center] at (8.5,7.5) {\Large 7};
\node[anchor=center] at (8.5,6.5) {\Large 6};
\node[anchor=center] at (8.5,5.5) {\Large 3};
\node[anchor=center] at (8.5,4.5) {};
\node[anchor=center] at (8.5,3.5) {};
...
\node[anchor=center] at (8.5,0.5) {};
        ...
        % short form: 040000800096000017502000306020040103000012060000730520170080005000003080000060900
    %
  };
  %
  \node[] at (5,-26.5) {\parbox{5cm}{\centering \sffamily Puzzle~\#%
