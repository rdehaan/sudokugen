...
\node[anchor=center] at (3.5,6.5) {\Large 9};
...
\node[anchor=center] at (8.5,0.5) {\Large 7};
        ...
        % short form: 400700002075000010000900000100600000000000324002080005050040000904020003000000007
    %
  };
  % PLAYER A, NUMBER 2
...
\node[anchor=center] at (6.5,5.5) {};
\node[anchor=center] at (6.5,4.5) {\Large 4};
\node[anchor=center] at (6.5,3.5) {};
...
\node[anchor=center] at (8.5,0.5) {};
        ...
        % short form: 000030001000002060054009000002906070081000406070000002005001804400060019908204000
    %
  };
  % PLAYER A, NUMBER 3
...
\node[anchor=center] at (0.5,5.5) {};
\node[anchor=center, minimum width=17pt, minimum height=17pt, pattern={Lines[distance=1.5pt,yshift=0.85pt]}, pattern color=NavyBlue!60] at (0.5,4.5) {};
...
\node[anchor=center] at (5.5,1.5) {};
\node[anchor=center] at (5.5,0.5) {};
\node[anchor=center, minimum width=17pt, minimum height=17pt, pattern=north west lines, pattern color=BrickRed!40] at (6.5,8.5) {};
...
\node[anchor=center] at (8.5,0.5) {};
        ...
        % short form: 009601000000800240100000080040700302005000000700000009000002010020050000058030000
    %
  };
  %
...
\node[anchor=center, minimum width=17pt, minimum height=17pt, pattern={Lines[distance=1.5pt,yshift=0.85pt]}, pattern color=NavyBlue!60] at (5.5,2.5) {};
...
\node[anchor=center] at (8.5,0.5) {\Large 3};
        ...
        % short form: 018000000500010690070000030750000000084000002000504080000070100000409060060001203
    %
  };
  % PLAYER B, NUMBER 2
  \node[] at (5,-10.75) {\parbox{5cm}{\sffamily \large \color{BrickRed}
...
\node[anchor=center] at (3.5,2.5) {};
\node[anchor=center] at (3.5,1.5) {};
\node[anchor=center, minimum width=17pt, minimum height=17pt, pattern={Lines[distance=1.5pt,yshift=0.85pt]}, pattern color=NavyBlue!60] at (3.5,0.5) {};
\node[anchor=center] at (4.5,8.5) {};
\node[anchor=center, minimum width=17pt, minimum height=17pt, pattern=north west lines, pattern color=BrickRed!40] at (4.5,7.5) {};
...
\node[anchor=center] at (7.5,0.5) {};
\node[anchor=center] at (8.5,8.5) {\Large 5};
\node[anchor=center] at (8.5,7.5) {};
\node[anchor=center] at (8.5,6.5) {};
\node[anchor=center] at (8.5,5.5) {};
\node[anchor=center] at (8.5,4.5) {};
...
\node[anchor=center] at (8.5,0.5) {};
        ...
        % short form: 900402005040000800200018000000705100003090040005000060000040000000000632061009000
    %
  };
  % PLAYER B, NUMBER 3
  \node[] at (5,-18.75) %{\parbox{5cm}{\sffamily \large \color{BrickRed} }};
...
\node[anchor=center] at (0.5,2.5) {};
\node[anchor=center] at (0.5,1.5) {};
\node[anchor=center] at (0.5,0.5) {\Large 5};
...
\node[anchor=center] at (1.5,2.5) {};
\node[anchor=center] at (1.5,1.5) {\Large 8};
\node[anchor=center] at (1.5,0.5) {};
\node[anchor=center] at (2.5,8.5) {\Large 4};
...
\node[anchor=center] at (8.5,0.5) {};
        ...
        % short form: 054070800000400000900056000400000007000180924090000060006790005080000200500020610
    %
  };
  %
  \node[] at (5,-26.5) {\parbox{5cm}{\centering \sffamily Puzzle~\#%
