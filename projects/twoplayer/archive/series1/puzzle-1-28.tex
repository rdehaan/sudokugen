...
\node[anchor=center, minimum width=17pt, minimum height=17pt, pattern={Lines[distance=1.5pt,yshift=0.85pt]}, pattern color=NavyBlue!60] at (3.5,1.5) {};
...
\node[anchor=center] at (8.5,0.5) {};
        ...
        % short form: 000030000000020000050000001092700050005008700000006840070100089000000000430000060
    %
  };
  % PLAYER A, NUMBER 2
...
\node[anchor=center] at (8.5,0.5) {\Large 6};
        ...
        % short form: 009000401070050000003002000000030800902008003000120605005610004020095010301000096
    %
  };
  % PLAYER A, NUMBER 3
...
\node[anchor=center] at (8.5,0.5) {};
        ...
        % short form: 000201307100060000004050090300080561509000200000000000420000800805007002006800000
    %
  };
  %
...
\node[anchor=center] at (8.5,0.5) {\Large 2};
        ...
        % short form: 100056720600270093000000000030900500007060000460800000090000080300680010000700902
    %
  };
  % PLAYER B, NUMBER 2
  \node[] at (5,-10.75) {\parbox{5cm}{\sffamily \large \color{BrickRed}
...
\node[anchor=center, minimum width=17pt, minimum height=17pt, pattern=north west lines, pattern color=BrickRed!40] at (6.5,7.5) {};
...
\node[anchor=center] at (8.5,0.5) {};
        ...
        % short form: 500800100060007000002001905003980000086000000400100500000060210007300049000004700
    %
  };
  % PLAYER B, NUMBER 3
  \node[] at (5,-18.75) %{\parbox{5cm}{\sffamily \large \color{BrickRed} }};
...
\node[anchor=center] at (8.5,0.5) {\Large 4};
        ...
        % short form: 160800700070010000400000080040000005000000820098003400050100000007500019600209004
    %
  };
  %
  \node[] at (5,-26.5) {\parbox{5cm}{\centering \sffamily Puzzle~\#%
