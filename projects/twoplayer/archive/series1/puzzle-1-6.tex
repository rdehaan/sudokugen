...
\node[anchor=center, minimum width=17pt, minimum height=17pt, pattern={Lines[distance=1.5pt,yshift=0.85pt]}, pattern color=NavyBlue!60] at (4.5,5.5) {};
...
\node[anchor=center] at (8.5,0.5) {};
        ...
        % short form: 004000708000006030020900500000800067400003000130050009057100200000700000200004000
    %
  };
  % PLAYER A, NUMBER 2
...
\node[anchor=center] at (8.5,0.5) {\Large 3};
        ...
        % short form: 001320500050000000008000409562000100000009000000200007005860004070000000906510003
    %
  };
  % PLAYER A, NUMBER 3
...
\node[anchor=center] at (8.5,0.5) {};
        ...
        % short form: 490000000000270005300040000700000140001009200060500000000000310000005004600028000
    %
  };
  %
...
\node[anchor=center] at (8.5,3.5) {};
\node[anchor=center] at (8.5,2.5) {\Large 8};
\node[anchor=center] at (8.5,1.5) {};
\node[anchor=center] at (8.5,0.5) {};
        ...
        % short form: 000890003900006000004007062400050009201000006030000020002409038007038250000000000
    %
  };
  % PLAYER B, NUMBER 2
  \node[] at (5,-10.75) {\parbox{5cm}{\sffamily \large \color{BrickRed}
...
\node[anchor=center] at (0.5,8.5) {};
\node[anchor=center] at (0.5,7.5) {};
\node[anchor=center, minimum width=17pt, minimum height=17pt, pattern=north west lines, pattern color=BrickRed!40] at (0.5,6.5) {};
\node[anchor=center] at (0.5,5.5) {\Large 7};
\node[anchor=center] at (0.5,4.5) {};
\node[anchor=center] at (0.5,3.5) {};
\node[anchor=center] at (0.5,2.5) {};
...
\node[anchor=center] at (8.5,0.5) {\Large 6};
        ...
        % short form: 000008000000150009000000340701000000003070004049003080000032000800504090000000106
    %
  };
  % PLAYER B, NUMBER 3
  \node[] at (5,-18.75) %{\parbox{5cm}{\sffamily \large \color{BrickRed} }};
...
\node[anchor=center] at (8.5,0.5) {};
        ...
        % short form: 305900004604000000000002001190080700508007203700005900000000500000030067000008000
    %
  };
  %
  \node[] at (5,-26.5) {\parbox{5cm}{\centering \sffamily Puzzle~\#%
